...
namespace EXPERMIN.SERVICE.Storage.Implementations
{
    public class UpcloudStorageServices: IFileStorageService
    {
        private readonly StorageOptions _settings;
        public UpcloudStorageServices(IOptions<StorageOptions> settings)
        {
